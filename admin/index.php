...
$seccionesValidas = [
    ...
    "admin_capitulos" => [
        "titulo" => "Administración de Capitulos",
        "restringido" => true
    ],    
    "admin_artistas" => [
...
<head>
    ...
    <title>La Tiendita de Peliculas: <?= $titulo ?></title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-info bg-info">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">La Tiendita de Peliculas</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item <?= isset($_SESSION["loggedIn"]) ? "" : "d-none"  ?>">
                        <a class="nav-link active" href="index.php?sec=admin_peliculas">Peliculas</a>
                    </li>                    
                    <li class="nav-item <?= isset($_SESSION["loggedIn"]) ? "" : "d-none"  ?>">
                        <a class="nav-link active" href="index.php?sec=admin_capitulos">Capitulos</a>
                    </li>
                    <li class="nav-item <?= isset($_SESSION["loggedIn"]) ? "" : "d-none"  ?>">
